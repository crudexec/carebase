...
const TIVisitPersonalWorkReading = ({
  ...
  useEffect(() => {
    if (!tiForm?.personalWorkReading) return;

    setMethod("PATCH");
    const { personalWorkReading } = tiForm;
    ...
    setValue("other_description", personalWorkReading.other_specify || "");
    setValue(
      "readABook",
...
export default TIVisitPersonalWorkReading;
