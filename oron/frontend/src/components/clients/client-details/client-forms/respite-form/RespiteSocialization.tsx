...
const RespiteSocialization = ({
  ...
  useEffect(() => {
    if (!respiteForm?.socialization) return;

    setMethod("PATCH");
    const { socialization } = respiteForm;
    ...
    if (socialization.basketball)
      selectedRecreationActivities.push("Basketball");
...
export default RespiteSocialization;
