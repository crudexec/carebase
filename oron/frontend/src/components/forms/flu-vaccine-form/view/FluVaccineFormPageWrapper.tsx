...
import { FLU_VACCINE_FORM_SIDEBAR } from "@/constants";
...
const FluVaccineFormPageWrapper = () => {
  const {
    formInfoLoading,
    userDataLoading,
    formDataLoading,
  ...
  return (
    <div className="w-full flex flex-col gap-5 relative">
      ...
      {status === "Approved" && (
        <FormApprovedModal formName="Flu Vaccine Attestation and Declination Form" />
      )}
        ...
        <BreadCrumb
          links={[
            ...
            },
            {
              ...
              route:
                "/onboarding/form/flu-vaccine-attestation-declination-form",
            },
          ]}
          fixed={true}
        />
        ...
        <div className="w-full flex flex-col">
          <div className="lg:fixed lg:mt-5 text-[30px] lg:z-[500] w-full xl:w-[80%] pr-10 bg-white font-[600] text-[#101828] xl:py-5 flex flex-col lg:flex-row lg:justify-between flex-wrap lg:items-center gap-5">
            <div className="flex flex-col lg:flex-row lg:items-center gap-5">
              <span>Flu Vaccine Attestation and Declination</span>
      ...
      <section className="relative w-full flex flex-col lg:flex-row lg:mt-0 xl:mt-[90px] mt-0">
        <SideNavigation
          formSidebar={FLU_VACCINE_FORM_SIDEBAR}
...
export default FluVaccineFormPageWrapper;
