...
import { EMPLOYEE_DEMOGRAPHIC_FORM_SIDEBAR } from "../logic/constant";
...
const EmployeeDemographicFormPageWrapper = () => {
  const {
    formInfoLoading,
    userDataLoading,
    formDataLoading,
  ...
  if (userDataLoading || formInfoLoading || formDataLoading) {
    return <Loader />;
  }
  ...
  return (
    <div className="w-full flex flex-col gap-5">
      ...
      {status === "Approved" && (
        <FormApprovedModal formName="Employee Demographic Form" />
      )}
        ...
        <div className="w-full flex flex-col">
          <div className="lg:fixed lg:mt-5 text-[30px] lg:z-[500] w-full xl:w-[80%] pr-10 bg-white font-[600] text-[#101828] xl:py-5 flex flex-col lg:flex-row lg:justify-between flex-wrap lg:items-center gap-5">
            <div className="flex flex-col lg:flex-row lg:items-center gap-5">
              <span>Employee Demographic Form</span>
      ...
      <section className="relative w-full flex flex-col lg:flex-row lg:mt-0 xl:mt-[90px] mt-0">
        <SideNavigation
          formSidebar={EMPLOYEE_DEMOGRAPHIC_FORM_SIDEBAR}
...
export default EmployeeDemographicFormPageWrapper;
