...
import { handlePneumococcalSignatureSubmission } from "@/actions/forms";
import { PneumococcalSignature } from "@/types/form-types/PneumococcalFormTypes";
...
const Signature = ({
  ...
  user: User;
  method: "POST" | "PATCH";
  processedSignature: PneumococcalSignature | undefined;
  refetch: any;
  ...
  const { mutate, isPending } = useCustomMutation(
    async (imageURL: string) => {
      ...
      const response = await handlePneumococcalSignatureSubmission(
        form,
        token,
        method
      );
    ...
    ["pneumococcalForm", "formData", "offerLetter"]
  );
  ...
  }, [processedSignature, handleToggleSign, signMonitor]);
