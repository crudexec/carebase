...
const SignupPage = () => {
  ...
  const handleFormSubmit = async (
    ...
    try {
      const response = await handleSignup(data, "STANDARD");
  ...
  return (
    <PageContainer>
      <FormPanel>
        ...
        >
          <FormHeader heading="Sign up" description="Create your account" />
          ...
          <p className="text-[14px] text-[#64748B] font-[400] w-full text-center mt-5">
            ...
            <Link href="/login" className="text-[#2563EB] ml-5 font-[600]">
              Log in
            </Link>
          </p>
        </form>
