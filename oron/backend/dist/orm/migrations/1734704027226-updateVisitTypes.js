...
exports.updateVisitTypes1734704027226 = void 0;
class updateVisitTypes1734704027226 {
    constructor() {
        this.name = 'updateVisitTypes1734704027226';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`
            ...
            ADD "treatment_plan_type" "public"."treatment_basic_information_treatment_plan_type_enum" DEFAULT 'IISS_Assessment'
        `);
        await queryRunner.query(`
        ...
        await queryRunner.query(`
            ...
            ADD "treatment_plan_type" "public"."treatment_schedule_treatment_plan_type_enum" DEFAULT 'IISS_Assessment'
        `);
        await queryRunner.query(`
        ...
        await queryRunner.query(`
            ...
            ADD "treatment_plan_type" "public"."treatment_goal_treatment_plan_type_enum" DEFAULT 'IISS_Assessment'
        `);
        await queryRunner.query(`
        ...
        await queryRunner.query(`
            ...
            ADD "treatment_plan_type" "public"."treatment_goal_signature_treatment_plan_type_enum" DEFAULT 'IISS_Assessment'
        `);
        await queryRunner.query(`
    ...
    async down(queryRunner) {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "treatment_goal_signature" DROP COLUMN "treatment_plan_type"
        `);
        await queryRunner.query(`
            DROP TYPE "public"."treatment_goal_signature_treatment_plan_type_enum"
        `);
        await queryRunner.query(`
            ALTER TABLE "treatment_goal" DROP COLUMN "treatment_plan_type"
        `);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "treatment_schedule" DROP COLUMN "treatment_plan_type"
        `);
        await queryRunner.query(`
            DROP TYPE "public"."treatment_schedule_treatment_plan_type_enum"
        `);
        await queryRunner.query(`
            ALTER TABLE "treatment_basic_information" DROP COLUMN "treatment_plan_type"
        `);
        await queryRunner.query(`
...
exports.updateVisitTypes1734704027226 = updateVisitTypes1734704027226;
//# sourceMappingURL=1734704027226-updateVisitTypes.js.map