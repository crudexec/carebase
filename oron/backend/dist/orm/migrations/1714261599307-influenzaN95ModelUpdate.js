...
exports.influenzaN95ModelUpdate1714261599307 = void 0;
class influenzaN95ModelUpdate1714261599307 {
    constructor() {
        this.name = 'influenzaN95ModelUpdate1714261599307';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`
            ALTER TABLE "mmr_signature"
                RENAME COLUMN "mmr_form_id" TO "flu_form_id"
        `);
        await queryRunner.query(`
            ALTER TABLE "mmr_signature"
                RENAME CONSTRAINT "UQ_da4b2dd99281a99f0d6862ce7a8" TO "UQ_d601c59d870a161d2232e05a550"
        `);
        await queryRunner.query(`
        ...
        await queryRunner.query(`
            ALTER TABLE "mmr_signature"
                RENAME COLUMN "flu_form_id" TO "mmr_form_id"
        `);
        await queryRunner.query(`
            ALTER TABLE "mmr_signature"
                RENAME CONSTRAINT "UQ_d601c59d870a161d2232e05a550" TO "UQ_da4b2dd99281a99f0d6862ce7a8"
        `);
        await queryRunner.query(`
...
exports.influenzaN95ModelUpdate1714261599307 = influenzaN95ModelUpdate1714261599307;
//# sourceMappingURL=1714261599307-influenzaN95ModelUpdate.js.map