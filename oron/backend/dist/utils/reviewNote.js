...
exports.adminReview = void 0;
const components_1 = require("@react-email/components");
const React = __importStar(require("react"));
const server_1 = __importDefault(require("react-dom/server"));
const SendFormReviewTemplate = ({ username, formName, reviewNote }) => {
            ...
            React.createElement(components_1.Body, { className: "bg-white my-auto mx-auto font-sans" },
                React.createElement(components_1.Container, { className: "border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[465px]" },
                    ...
                    React.createElement(components_1.Text, { className: "text-black text-[14px] leading-[24px]" },
                        ...
                        ". Our team has carefully reviewed your application, and we regret to inform you that it has not been approved at this time."),
                    React.createElement(components_1.Text, { className: "text-black text-[14px] leading-[24px]" }, "Feedback from the reviewer:"),
                    React.createElement(components_1.Text, { className: "text-black text-[14px] leading-[24px] " },
                        React.createElement("strong", null,
                            "\"",
                            reviewNote,
                            "\"")),
                    React.createElement(components_1.Text, null, "Kindly login to your employee portal to update the information."),
                    React.createElement("br", null),
                    React.createElement(components_1.Button, { className: "bg-[#2563EB] rounded text-white text-[12px] font-semibold no-underline text-center py-3 px-5", href: process.env.FRONTEND_URL }, "Update Information"),
                    React.createElement(components_1.Text, null, "If you have any further questions or need clarification on the feedback provided, please don't hesitate to reach out to our support team."),
...
const adminReview = ({ username, formName, reviewNote }) => server_1.default.renderToStaticMarkup(React.createElement(SendFormReviewTemplate, { username: username, formName: formName, reviewNote: reviewNote }));
exports.adminReview = adminReview;
exports.default = exports.adminReview;
//# sourceMappingURL=reviewNote.js.map