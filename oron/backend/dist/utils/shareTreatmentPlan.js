...
exports.SharedTreatmentPlanTemplate = void 0;
const components_1 = require("@react-email/components");
const React = __importStar(require("react"));
const server_1 = __importDefault(require("react-dom/server"));
const SharedTreatmentPlan = ({ recipientName, childName, invitationLink }) => {
            ...
            React.createElement(components_1.Body, { className: "bg-white my-auto mx-auto font-sans" },
                React.createElement(components_1.Container, { className: "border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[465px]" },
                    ...
                    React.createElement(components_1.Text, null,
                        ...
                        childName,
                        ". Kindly find attached a copy of the latest version for your reference."),
                    React.createElement(components_1.Text, null, "If you have any questions or need further clarifications, please don't hesitate to reach out to us."),
...
const SharedTreatmentPlanTemplate = ({ childName, recipientName, invitationLink }) => server_1.default.renderToStaticMarkup(React.createElement(SharedTreatmentPlan, { recipientName: recipientName, childName: childName, invitationLink: invitationLink }));
exports.SharedTreatmentPlanTemplate = SharedTreatmentPlanTemplate;
exports.default = exports.SharedTreatmentPlanTemplate;
