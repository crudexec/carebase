...
exports.ParentSignatureConfirmationTemplate = void 0;
const components_1 = require("@react-email/components");
const React = __importStar(require("react"));
const server_1 = __importDefault(require("react-dom/server"));
const ParentSignatureConfirmation = ({ parentName, childName, invitationLink }) => {
            ...
            React.createElement(components_1.Body, { className: "bg-white my-auto mx-auto font-sans" },
                React.createElement(components_1.Container, { className: "border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[465px]" },
                    ...
                    React.createElement(components_1.Text, null,
                        "Thank you for reviewing and signing ",
                        childName,
                        "'s treatment plan. Your signature has been successfully recorded,and you can download the treatment plan here."),
                    React.createElement(components_1.Button, { className: "bg-[#2563EB] rounded text-white text-[12px] font-semibold no-underline text-center py-3 px-5", href: invitationLink }, "Download Treatment Plan"),
                    React.createElement(components_1.Text, null,
...
const ParentSignatureConfirmationTemplate = ({ childName, parentName, invitationLink }) => server_1.default.renderToStaticMarkup(React.createElement(ParentSignatureConfirmation, { parentName: parentName, childName: childName, invitationLink: invitationLink }));
exports.ParentSignatureConfirmationTemplate = ParentSignatureConfirmationTemplate;
exports.default = exports.ParentSignatureConfirmationTemplate;
//# sourceMappingURL=treatmentSignatureConfirmation.js.map