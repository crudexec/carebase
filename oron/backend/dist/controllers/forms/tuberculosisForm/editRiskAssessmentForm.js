...
const editTbRiskAssessmentForm = async (req, res, next) => {
    ...
    try {
        ...
        if (tuberculosisMantouxForm) {
            ...
            const customError = new CustomError_1.CustomError(400, 'General', 'Tuberculosis Mantoux form does not exist', [
...
exports.editTbRiskAssessmentForm = editTbRiskAssessmentForm;
//# sourceMappingURL=editRiskAssessmentForm.js.map