...
const editTreatmentGoal = async (req, res, next) => {
    ...
    try {
        ...
        const customError = new CustomError_1.CustomError(400, 'Raw', 'Network Error Updating Treatment Goal Information', null, err);
        return next(customError);
    }
    finally {
...
exports.editTreatmentGoal = editTreatmentGoal;
//# sourceMappingURL=editTreatmentGoals.js.map