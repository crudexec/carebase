...
exports.editTreatmentBasicInformation = void 0;
const typeorm_1 = require("typeorm");
const basicInformation_1 = require("orm/entities/TreatmentPlan/basicInformation");
const CustomError_1 = require("utils/response/custom-error/CustomError");
const editTreatmentBasicInformation = async (req, res, next) => {
    ...
    try {
        ...
        const customError = new CustomError_1.CustomError(400, 'Raw', 'Network Error Updating Treatment Basic Information', null, err);
        return next(customError);
    }
    finally {
...
exports.editTreatmentBasicInformation = editTreatmentBasicInformation;
