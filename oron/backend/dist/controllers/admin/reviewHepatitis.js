...
exports.ReviewHepatitisForm = void 0;
...
const ReviewHepatitisForm = async (req, res, next) => {
    ...
    try {
        ...
        await hepatitisBFormRepository.update({ id: form_id }, { status: genericEnums_1.Status.REVIEWED, review_notes });
        await (0, emailService_1.SendReviewEmail)(user.first_name, `Hepatitis B Form`, review_notes, String(user.email));
...
exports.ReviewHepatitisForm = ReviewHepatitisForm;
//# sourceMappingURL=reviewHepatitis.js.map