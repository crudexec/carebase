...
exports.ApproveDemographicForm = void 0;
...
const ApproveDemographicForm = async (req, res, next) => {
    ...
    try {
        ...
        await employeePersonalInformationRepository.update({ id: form_id }, { status: genericEnums_1.Status.APPROVED });
        await (0, emailService_1.sendApproveMail)(employeeForm.first_name, `Employee Demographic Form`, String(user.email));
...
exports.ApproveDemographicForm = ApproveDemographicForm;
//# sourceMappingURL=approveEmployeeDemographic.js.map