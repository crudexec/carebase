...
exports.ApprovePneumococcalForm = void 0;
...
const ApprovePneumococcalForm = async (req, res, next) => {
    ...
    try {
        ...
        await pneumococcalFormRepository.update({ id: form_id }, { status: genericEnums_1.Status.APPROVED });
        ...
        await (0, emailService_1.sendApproveMail)(user.first_name, `Pneumococcal Form`, String(user.email));
...
exports.ApprovePneumococcalForm = ApprovePneumococcalForm;
//# sourceMappingURL=approvePneumococcal.js.map