...
exports.filterFcVisitExport = void 0;
...
const filterFcVisitExport = async (req, res, next) => {
    try {
        ...
        const customError = new CustomError_1.CustomError(400, 'Raw', 'Error retrieving FC visit logs for export', null, err);
        return next(customError);
    }
};
exports.filterFcVisitExport = filterFcVisitExport;
//# sourceMappingURL=exportFcVisit.js.map