...
exports.addBehaviorManagement = void 0;
...
const addBehaviorManagement = async (req, res, next) => {
    try {
        ...
        for (let i = 0; i < behaviorManagementArray.length; i++) {
            ...
            const { behavior_type, behavior_description, what_time_did_behavior_occur, antecedent, consequence, setting, how_many_times_did_behavior_occur, for_how_long_did_behavior_occur, severity, other_crisis_intervention, other_specific_description, visit_full_form_id, } = behaviorManagementData;
            ...
            behaviorManagement.status = genericEnums_1.Status.IN_PROGRESS;
        ...
        const customError = new CustomError_1.CustomError(400, 'Raw', 'Network Error Adding Behavior Management', null, err);
        return next(customError);
    }
};
exports.addBehaviorManagement = addBehaviorManagement;
//# sourceMappingURL=addBehaviorManagement.js.map