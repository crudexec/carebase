...
exports.editUtilizationOfMoney = void 0;
const typeorm_1 = require("typeorm");
const utilizationOfMoney_1 = require("orm/entities/VisitLog/stepTwo/utilizationOfMoney");
const CustomError_1 = require("utils/response/custom-error/CustomError");
const editUtilizationOfMoney = async (req, res, next) => {
    try {
        let { handing_bills_to_cashier, waiting_for_and_receiving_debit_credit_card, handing_coins_to_cashier, counting_the_change_to_make_sure_it_is_correct, handing_debit_credit_card_to_cashier, determining_and_handling_the_correct_estimated_amount, using_the_dollar_up_program, obtaining_and_reviewing_receipt_for_accuracy, waiting_for_and_accepting_the_change, this_activity_occured_at, utilization_of_money_id, } = req.body;
        ...
        if (!utilizationOfMoneyExists) {
            const customError = new CustomError_1.CustomError(404, 'General', `Utilization of Money not found`, [
        ...
        const customError = new CustomError_1.CustomError(400, 'Raw', 'Network Error Updating Utilization of Money', null, err);
        return next(customError);
    }
};
exports.editUtilizationOfMoney = editUtilizationOfMoney;
//# sourceMappingURL=editUtilizationOfMoney.js.map