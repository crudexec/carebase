...
exports.editPersonalCareBowelControl = void 0;
const typeorm_1 = require("typeorm");
const personalCareAndControl_1 = require("orm/entities/VisitLog/stepTwo/personalCareAndControl");
const CustomError_1 = require("utils/response/custom-error/CustomError");
const editPersonalCareBowelControl = async (req, res, next) => {
    try {
        let { client_name_used_bathroom_without_assistance, assisted_client_with_changing_diapers, assisted_client_with_toileting, other_bowel, other_specify_bowel, supported_client_with_bathing, supported_client_with_brushing_teeth, supported_client_with_shampooing, supported_client_with_toweling, supported_client_with_showering, supported_client_with_menstrual_care, other_personal_hygiene, other_specify_personal_hygiene, personal_care_and_bladder_control_id, } = req.body;
        ...
        if (!formExists) {
            const customError = new CustomError_1.CustomError(404, 'General', `Personal Care and Bladder Control not found`, [
        ...
        await personalCareAndBladderControlRepository.update(personal_care_and_bladder_control_id, personalCareAndBladderControl);
        return res.customSuccess(200, 'Personal Care and Bladder Control successfully updated.', personalCareAndBladderControl);
    }
    catch (err) {
        const customError = new CustomError_1.CustomError(400, 'Raw', 'Network Error Updating Personal Care and Bladder Control', null, err);
        return next(customError);
    }
};
exports.editPersonalCareBowelControl = editPersonalCareBowelControl;
//# sourceMappingURL=editPersonalCareBowelControl.js.map