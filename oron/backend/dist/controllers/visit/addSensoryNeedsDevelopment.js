...
exports.addSensoryNeedsAndMotorDevelopment = void 0;
...
const addSensoryNeedsAndMotorDevelopment = async (req, res, next) => {
    try {
        ...
        sensoryNeedsAndMotorDevelopment.status = genericEnums_1.Status.IN_PROGRESS;
        ...
        const savedSensoryNeedsAndMotorDevelopment = await sensoryNeedsAndMotorDevelopmentRepository.save(sensoryNeedsAndMotorDevelopment);
        ...
        return res.customSuccess(200, 'Sensory Needs and Motor Development successfully added.', savedSensoryNeedsAndMotorDevelopment);
    }
    catch (err) {
        const customError = new CustomError_1.CustomError(400, 'Raw', 'Network Error Adding Sensory Needs and Motor Development', null, err);
        return next(customError);
    }
};
exports.addSensoryNeedsAndMotorDevelopment = addSensoryNeedsAndMotorDevelopment;
//# sourceMappingURL=addSensoryNeedsDevelopment.js.map