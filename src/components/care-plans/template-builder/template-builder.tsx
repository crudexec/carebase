...
interface TemplateBuilderProps {
  template: CarePlanTemplateData;
  onChange: (template: CarePlanTemplateData) => void;
}

type DragItem =
  | { type: "section"; section: CarePlanTemplateSectionData }
  | { type: "field"; field: CarePlanTemplateFieldData };
...
export function TemplateBuilder({ template, onChange }: TemplateBuilderProps) {
  ...
  const updateTemplate = (updates: Partial<CarePlanTemplateData>) => {
  ...
  const updateField = (fieldId: string, updates: Partial<CarePlanTemplateFieldData>) => {
    updateTemplate({
