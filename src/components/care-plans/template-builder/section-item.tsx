...
import { CarePlanTemplateSectionData, CarePlanTemplateFieldData } from "@/lib/care-plans/types";
...
interface SectionItemProps {
  ...
  onToggleExpand: () => void;
  onUpdateSection: (updates: Partial<CarePlanTemplateSectionData>) => void;
...
export function SectionItemOverlay({ section }: { section: CarePlanTemplateSectionData }) {
  return (
