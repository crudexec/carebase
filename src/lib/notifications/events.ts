...
export const EVENT_CONFIGS: Record<NotificationEventType, EventConfig> = {
  ...
  CREDENTIAL_EXPIRING_60_DAYS: {
    eventType: "CREDENTIAL_EXPIRING_60_DAYS",
    description: "Alert when a credential expires in 60 days",
    defaultRecipientRoles: ["CARER"],
    priority: "LOW",
    defaultChannels: ["EMAIL", "IN_APP"],
    variables: [
  ...
  CREDENTIAL_EXPIRING_30_DAYS: {
    eventType: "CREDENTIAL_EXPIRING_30_DAYS",
    description: "Alert when a credential expires in 30 days",
    defaultRecipientRoles: ["CARER", "ADMIN", "OPS_MANAGER"],
    priority: "MEDIUM",
    defaultChannels: ["EMAIL", "IN_APP"],
    variables: [
      "carerName",
  ...
  CREDENTIAL_EXPIRING_7_DAYS: {
    eventType: "CREDENTIAL_EXPIRING_7_DAYS",
    description: "Alert when a credential expires in 7 days",
    defaultRecipientRoles: ["CARER", "ADMIN", "OPS_MANAGER"],
    priority: "HIGH",
    defaultChannels: ["EMAIL", "SMS", "IN_APP"],
    variables: [
  ...
  CREDENTIAL_EXPIRED: {
    ...
    description: "Alert when a credential has expired",
    defaultRecipientRoles: ["CARER", "ADMIN", "OPS_MANAGER"],
    priority: "CRITICAL",
    defaultChannels: ["EMAIL", "SMS", "IN_APP"],
    variables: [
  ...
  CREDENTIAL_RENEWED: {
    eventType: "CREDENTIAL_RENEWED",
    description: "Notification when a credential is renewed",
    defaultRecipientRoles: ["ADMIN", "OPS_MANAGER"],
    priority: "LOW",
    defaultChannels: ["EMAIL", "IN_APP"],
    variables: [
  ...
  CREDENTIAL_VERIFICATION_NEEDED: {
    eventType: "CREDENTIAL_VERIFICATION_NEEDED",
    description: "Alert when a credential needs admin verification",
    defaultRecipientRoles: ["ADMIN", "OPS_MANAGER"],
    priority: "MEDIUM",
    defaultChannels: ["EMAIL", "IN_APP"],
    variables: [
  ...
  MEDICATION_DUE: {
    ...
    description: "Alert when medication is due for administration",
    defaultRecipientRoles: ["CARER", "STAFF"],
    priority: "HIGH",
    defaultChannels: ["IN_APP"],
    variables: ["clientName", "medicationName", "dueTime", "doseAmount"],
  },
  MEDICATION_OVERDUE: {
    eventType: "MEDICATION_OVERDUE",
    description: "Alert when medication is overdue",
    defaultRecipientRoles: ["CARER", "STAFF", "SUPERVISOR"],
    priority: "CRITICAL",
    defaultChannels: ["EMAIL", "IN_APP"],
    variables: ["clientName", "medicationName", "scheduledTime", "minutesOverdue"],
  },
  MEDICATION_MISSED: {
    eventType: "MEDICATION_MISSED",
    description: "Alert when medication administration was missed",
    defaultRecipientRoles: ["SUPERVISOR", "CLINICAL_DIRECTOR", "ADMIN"],
    priority: "CRITICAL",
    defaultChannels: ["EMAIL", "SMS", "IN_APP"],
    variables: ["clientName", "medicationName", "scheduledTime", "carerName"],
  },
  PRN_FOLLOWUP_DUE: {
    eventType: "PRN_FOLLOWUP_DUE",
    description: "Reminder for PRN medication effectiveness follow-up",
    defaultRecipientRoles: ["CARER", "STAFF"],
    priority: "MEDIUM",
    defaultChannels: ["IN_APP"],
    variables: ["clientName", "medicationName", "administeredTime", "followupTime"],
  },
  NARCOTIC_COUNT_REQUIRED: {
    eventType: "NARCOTIC_COUNT_REQUIRED",
    description: "Alert when narcotic count is required at shift change",
    defaultRecipientRoles: ["CARER", "STAFF", "SUPERVISOR"],
    priority: "HIGH",
    defaultChannels: ["IN_APP"],
    variables: ["shiftName", "countDueTime"],
  },
  NARCOTIC_DISCREPANCY: {
    eventType: "NARCOTIC_DISCREPANCY",
    description: "Critical alert for narcotic count discrepancy",
    defaultRecipientRoles: ["SUPERVISOR", "CLINICAL_DIRECTOR", "ADMIN"],
    priority: "CRITICAL",
    defaultChannels: ["EMAIL", "SMS", "IN_APP"],
    variables: ["medicationName", "expectedCount", "actualCount", "discrepancy", "carerName"],
  },
  REFILL_NEEDED: {
    eventType: "REFILL_NEEDED",
    description: "Alert when medication refill is needed",
    defaultRecipientRoles: ["STAFF", "SUPERVISOR", "OPS_MANAGER"],
    priority: "MEDIUM",
    defaultChannels: ["EMAIL", "IN_APP"],
    variables: ["clientName", "medicationName", "remainingDoses", "lastFillDate"],
  },
  REFILL_REQUEST_SUBMITTED: {
    eventType: "REFILL_REQUEST_SUBMITTED",
    description: "Notification when a refill request is submitted",
    defaultRecipientRoles: ["OPS_MANAGER", "ADMIN"],
    priority: "MEDIUM",
    defaultChannels: ["EMAIL", "IN_APP"],
    variables: ["clientName", "medicationName", "requestedBy", "requestDate"],
  },
  REFILL_REQUEST_APPROVED: {
    eventType: "REFILL_REQUEST_APPROVED",
    description: "Notification when a refill request is approved",
    defaultRecipientRoles: ["STAFF", "SUPERVISOR"],
    priority: "LOW",
    defaultChannels: ["IN_APP"],
    variables: ["clientName", "medicationName", "approvedBy", "approvalDate"],
  },
  REFILL_REQUEST_DENIED: {
    eventType: "REFILL_REQUEST_DENIED",
    description: "Notification when a refill request is denied",
    defaultRecipientRoles: ["STAFF", "SUPERVISOR"],
    priority: "MEDIUM",
    defaultChannels: ["EMAIL", "IN_APP"],
    variables: ["clientName", "medicationName", "deniedBy", "denialReason"],
  },
  DRUG_INTERACTION_ALERT: {
    eventType: "DRUG_INTERACTION_ALERT",
    description: "Alert for potential drug interaction",
    defaultRecipientRoles: ["CLINICAL_DIRECTOR", "ADMIN"],
    priority: "CRITICAL",
    defaultChannels: ["EMAIL", "IN_APP"],
    variables: ["clientName", "medication1", "medication2", "interactionSeverity", "description"],
  },
  DRUG_ALLERGY_ALERT: {
    eventType: "DRUG_ALLERGY_ALERT",
    description: "Alert for potential drug allergy",
    defaultRecipientRoles: ["CLINICAL_DIRECTOR", "ADMIN"],
    priority: "CRITICAL",
    defaultChannels: ["EMAIL", "SMS", "IN_APP"],
    variables: ["clientName", "medicationName", "allergen", "reaction"],
  },
  MEDICATION_EXPIRING: {
    eventType: "MEDICATION_EXPIRING",
    description: "Alert when medication is expiring soon",
    defaultRecipientRoles: ["STAFF", "SUPERVISOR"],
    priority: "MEDIUM",
    defaultChannels: ["EMAIL", "IN_APP"],
    variables: ["clientName", "medicationName", "expirationDate", "daysRemaining"],
  },
  MEDICATION_LOW_INVENTORY: {
    eventType: "MEDICATION_LOW_INVENTORY",
    description: "Alert when medication inventory is low",
    defaultRecipientRoles: ["STAFF", "SUPERVISOR", "OPS_MANAGER"],
    priority: "MEDIUM",
    defaultChannels: ["EMAIL", "IN_APP"],
    variables: ["medicationName", "currentQuantity", "minimumQuantity"],
  },
};
